...
def get_weather(lat, lon):
    ...
    vc_url = (
        ...
        f"weatherdata/forecast?locations={lat},{lon}&include=current&unitGroup=us&"
        f"key={VC_API_KEY}&contentType=json"
    )
    ...
    loc_key = f"{lat},{lon}"
    current = data.get("locations", {}).get(loc_key, {}).get("currentConditions", {})
